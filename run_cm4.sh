...
# Specific for Kivy running on Raspberry Pi Compute Module 4
set -e
...
OUTPUT_DIR=/workspace/outputs/kivy/cm4
CCACHE_LIMIT="50G"
...
DOCKER_RUN="docker run
    ...
    -v $(pwd)/graphs/kivy/cm4:$OUTPUT_DIR/graphs
    ${BUILDROOT_IMAGE:-va_buildroot}"

make() {
    echo "make BR2_EXTERNAL=${EXTERNAL_TREES_DIR}/kivy O=$OUTPUT_DIR BR2_DL_DIR=/workspace/dl"
}
